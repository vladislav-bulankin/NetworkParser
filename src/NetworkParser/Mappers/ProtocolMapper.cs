...
namespace NetworkParser.UI.Mappers;

internal static class ProtocolMapper {

    public static ProtocolModel MapEthernetPacket (EthernetPacket eth) {
    ...
    public static ProtocolModel MapIPPacket (IPPacket ip, string dnsSource, string dnsDist) {
    ...
    public static ProtocolModel MapTcpPacket (TcpPacket tcp) {
    ...
    public static ProtocolModel MapUdpPacket (UdpPacket udp) {
    ...
    public static ProtocolModel MapIcmpV4Packet (IcmpV4Packet icmpv4) {
        var icmpNode = new ProtocolModel("Internet Control Message Protocol");
        icmpNode.Children.Add(new ProtocolModel($"Type: {icmpv4.TypeCode}"));
        icmpNode.Children.Add(new ProtocolModel($"Checksum: 0x{icmpv4.Checksum:X4}"));
        return icmpNode;
    }

    public static ProtocolModel MapArpPacket (ArpPacket arp) {
